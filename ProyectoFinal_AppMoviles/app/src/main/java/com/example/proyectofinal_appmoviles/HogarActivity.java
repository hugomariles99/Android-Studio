...
public class HogarActivity extends AppCompatActivity {
    ...
    public Button botonCocina, botonInicio, botonBanos, botonInventario;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuItem_carrito:
                Intent submitIntent = new Intent(HogarActivity.this, carrito_articulos_activity.class);
    ...
    void showCustomDialog() {
        final Dialog dialog = new Dialog(HogarActivity.this);
    ...
    public void cambioDePantalla() {
        ...
        botonCocina.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent submitIntent = new Intent(HogarActivity.this, CocinaActivity.class);
                startActivity(submitIntent);
            }
        });
        ...
        botonBanos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent submitIntent = new Intent(HogarActivity.this, BanosActivity.class);
                startActivity(submitIntent);
            }
        });
        ...
        botonInicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent submitIntent = new Intent(HogarActivity.this, MainActivity.class);
                startActivity(submitIntent);
            }
        });
        ...
        botonInventario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent submitIntent = new Intent(HogarActivity.this, InventarioActivity.class);
                startActivity(submitIntent);
            }
        });
    }
