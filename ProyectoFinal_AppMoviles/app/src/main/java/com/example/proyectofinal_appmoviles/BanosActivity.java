...
public class BanosActivity extends AppCompatActivity {

    public Toolbar myToolbar;

    public Button botonCocina, botonInicio, botonHogar, botonInventario;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuItem_carrito:
                Intent submitIntent = new Intent(BanosActivity.this, carrito_articulos_activity.class);
    ...
    void showCustomDialog() {
        final Dialog dialog = new Dialog(BanosActivity.this);
    ...
    public void cambioDePantalla() {
        ...
        botonCocina.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent submitIntent = new Intent(BanosActivity.this, CocinaActivity.class);
                startActivity(submitIntent);
            }
        });
        ...
        botonHogar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent submitIntent = new Intent(BanosActivity.this, HogarActivity.class);
                startActivity(submitIntent);
            }
        });
        ...
        botonInicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent submitIntent = new Intent(BanosActivity.this, MainActivity.class);
                startActivity(submitIntent);
            }
        });
        ...
        botonInventario.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent submitIntent = new Intent(BanosActivity.this, InventarioActivity.class);
                startActivity(submitIntent);
            }
        });
    }
